    ...
    const handleNodeClick = (event, node) => {
      if (node.type === 'task') {
        ...
        setHighlighted({
          ...
          edges: new Set([
            ...relatedEdges,
            ...Array.from(connectedTasks).flatMap(task =>
              edges.filter(e => e.target === task.id).map(e => e.id)
            ),
          ]),
        });
      }
    ...
    return (
      <div style={{ width: '100vw', height: '100vh' }}>
        <ReactFlow
          ...
          edgeTypes={{ custom: CustomEdge }} // Register CustomEdge
        ...
        >
          ...
          <Controls>
            ...
            <ControlButton
              onClick={() => setHighlighted({ nodes: new Set(), edges: new Set() })}
